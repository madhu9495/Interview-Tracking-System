<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.wipro.its.service.AdministratorImpl" import="com.wipro.its.bean.CandidateBean"%>
